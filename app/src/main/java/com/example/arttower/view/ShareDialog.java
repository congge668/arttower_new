...
import com.example.arttower.adapter.ShareAdapter;
import com.example.arttower.falsedata.DataCreate;
import com.example.arttower.falsedata.ShareBean;
...
public class ShareDialog extends BaseBottomSheetDialog {
    ...
    private void setShareDatas() {
        ...
        shareBeans.add(new ShareBean(R.string.icon_comment, "私信好友", R.color.cl_FF0041));
